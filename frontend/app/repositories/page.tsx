    ...
    <main className="p-8 max-w-7xl mx-auto w-full space-y-8 bg-zinc-950/20 min-h-screen relative">
      ...
      <div>
        ...
        <p className="text-zinc-400 text-sm mt-2">
          Comprehensive database browser of AI repositories showing stars velocity and historical logs.
        </p>
      </div>
                ...
                {repos.map((repo) => (
                  <tr key={repo.id} className="hover:bg-zinc-900/20 transition">
                    ...
                    <td className="py-4 px-6 max-w-sm">
                      ...
                      <div className="text-zinc-400 text-xs truncate mt-0.5 max-w-[320px]">{repo.description}</div>
                    </td>
                    
                    {/* Category */}
                    <td className="py-4 px-4 text-zinc-300 font-medium">
                      {getCategoryName(repo.category_id)}
                    </td>
                    ...
                    <td className="py-4 px-6 text-center">
                      <div className="flex items-center justify-center space-x-3">
                        <button
                          ...
                          className="px-3 py-1.5 rounded-lg border border-zinc-700 hover:border-indigo-500 text-xs font-semibold text-zinc-300 hover:text-indigo-400 transition"
                        >
                          Growth History
                        </button>
                        <a
        ...
        <div className="fixed inset-0 bg-zinc-950/80 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in">
          <div className="bg-zinc-900 border border-zinc-800 w-full max-w-xl rounded-xl p-6 relative shadow-2xl">
            ...
            <div className="mt-6 pt-4 border-t border-zinc-800 flex justify-end">
              <button
                onClick={closeHistoryModal}
                className="px-4 py-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 font-semibold rounded-lg text-xs transition"
              >
                Close View
              </button>
            </div>
